...
def evaluate_jh(generator, model, threshold=0.05):
    ...
    image_ids = []
    coco = COCO()
    coco_true = coco.loadRes(coco.createAnnNumpy('/data/users/xiziwang/tools/nsp/JHdevkit/VOC2007','val'))
    ...
    coco_true = COCO()
    coco_true = coco_true.loadRes(coco_true.createAnnNumpy('/data/users/xiziwang/tools/nsp/JHdevkit/VOC2007','val'))
