...
import keras_retinanet.models.jh_retina

WEIGHTS_PATH_NO_TOP = 'https://github.com/fizyr/keras-models/releases/download/v0.0.1/ResNet-50-model.keras.h5'

custom_objects = keras_retinanet.models.jh_retina.custom_objects.copy()
...
def ResNet50RetinaNet(inputs, num_classes, weights='imagenet', *args, **kwargs):
    ...
    model = keras_retinanet.models.jh_retina.retinanet_bbox(inputs=inputs, num_classes=num_classes, backbone=resnet, *args, **kwargs)
